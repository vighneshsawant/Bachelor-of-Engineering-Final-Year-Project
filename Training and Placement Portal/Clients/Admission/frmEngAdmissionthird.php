      ...
      <div class="content_bg">
        <div class="mainbar1">
		  ...
		  <br><?php error_reporting(E_ALL ^ E_NOTICE); session_start(); 
				...
				?>
		   <form action="addEngAdmissionthird.php" method="post" enctype="multipart/form-data">
            <table>
			<tr valign="top">
				<td>
				</td>
				...
				<td colspan="2">
			   	...
			   	<tr>
					<td >
						<select name="deyear" id="deyear" required>
				...
				<tr>
					<td></td>
					<td><b>To be filled and signed</b></td>
					<td><b>by the candidate before submitting to the college office</b>
					</td>
				</tr>
			</table>
			<table>
				...
				<tr>
					...
					<td style="width:100px">
						...
						Style="font:normal 12px/1.8em Arial, Helvetica, sans-serif;width:100px" name="recnum"  />
					</td>
					<td><span class="error">*</span><b>Date</b></td>
					<td>
						<input type="date" id="recdate" value="<?php echo $_SESSION['recdate']; ?>" 
						Style="font:normal 12px/1.8em Arial, Helvetica, sans-serif;width:150px" name="recdate"  />
					</td>
				</tr>
			</table>
			<table>

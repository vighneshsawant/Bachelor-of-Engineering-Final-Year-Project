      ...
      <div class="content_bg">
        <div class="mainbar1">
		  ...
		  <br><?php error_reporting(E_ALL ^ E_NOTICE); session_start(); 
				...
				?>
		   <form action="degreefirstyear.php" method="post" enctype="multipart/form-data">
            <table style="padding:0px 13px;">
			 <tr valign="top">
				<th colspan="3" class="color"  style="padding:10px 130px;font-size:25px;font-weight:bold;text-decoration:underline;">
					ACADEMIC YEAR 2015-2016
				</th>
				<th>
					<img scr="" width="150px" height="150px" id="imgAvatar">
				</th>
			 </tr>
			   	<tr>
					<td>First Year<span class="error">*</span></td>
				...
				<tr>
					<td style="padding-left:30px">To be filled</td>
					<td>and signed by the candidate before submitting to the college office
					</td>
				</tr>
				<tr>
					<td><span class="error">*</span>Adhar Card Number</td>
					<td>
						<input id="adcnum" value="<?php echo $_SESSION['adcnum']; ?>" 
						Style="color:#959595;font:normal 12px/1.8em Arial, Helvetica, sans-serif;width:450px" name="adcnum"  required/>
					</td>
				</tr>
			</table>
			...
			<table >
				...
				<tr valign="top">
					...
					<td colspan="3">
						<textarea id="caddress" class="select" rows="2" cols="98" name="caddress"  ><?php echo $_SESSION['caddress']; ?>
						</textarea>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input id="slmobno" value="<?php echo $_SESSION['slmobno']; ?>" class="text" name="slmobno"  required/>
					</td>
					<td>Email <span class="error">*</span></td>
					<td>
						<input id="slemail" value="<?php echo $_SESSION['slemail']; ?>" class="text" name="slemail"  required/>
					</td>
				</tr>
				<tr valign="top">
				...
				<tr>
					...
					<td>
						<input id="ptelno" value="<?php echo $_SESSION['ptelno']; ?>" class="text" name="ptelno"  />
					</td>
					<td>Mob. No.: <span class="error">*</span></td>
					<td>
						<input id="pmobno" value="<?php echo $_SESSION['pmobno']; ?>" class="text" name="pmobno"  />
					</td>
				</tr>
				<tr valign="top">

      ...
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            ...
            <div class="clr"></div>
            <p class="post-data"><span class="date"><?php $date=date("jS  F Y");echo $date;?></span> &nbsp;|&nbsp; New company <a href="frmRegistration.php">please register</a>
            <div class="clr"></div>
			<h2><span><?php if($_GET['name']<>""){ echo $_GET['name'].", please login";}else{echo "Registered Companies Please Login";}?></span></h2>
        ...
        <?php error_reporting(E_ALL ^ E_NOTICE);  
                ...
                <li>
                  <label>Username &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input  type="text" id="name"  name="username"  />(required)</label>
                </li>
                <li>
                  <label>Password &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
